...
def main():
    ...
    #Plot loads convergence histories
        ...
        figures[0].savefig(f'figures/CL_AoA3p06.png', dpi=500);
        figures[1].savefig(f'figures/CD_AoA3p06.png', dpi=500);
        ...
        figures[0].savefig(f'figures/Residuals_AoA3p06.png', dpi=500);
